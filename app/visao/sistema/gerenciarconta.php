...
if ($_SERVER['REQUEST_METHOD'] == 'POST') :
    ...
    <form class="table centered" id="ajaxForm" method="post" action="index.php?c=sistema&a=gerenciarconta">
        <fieldset>
            ...
            <div class="line">
                <label>Nome</label>
                <input required name="nome"  type="text" value="<? echo $this->nome ?>">
            </div>
            <div class="line">
                <label>Sobrenome</label>
                <input required name="sobrenome"  type="text" value="<? echo $this->sobrenome ?>">
            </div>
            <div class="line">
                <label>email</label>
                <input required disabled type="text"  name="email" value="<? echo $this->email ?>">
            </div>
            <div class="line">
