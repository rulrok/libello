...
if ($_SERVER['REQUEST_METHOD'] == 'POST') :
    ...
    $controlador->acaoVerificarEdicaoPolo();
else:
    ?>
    <!--Início da página-->
    ...
    <form class="table centered" id="ajaxForm" method="post" action="index.php?c=cursospolos&a=editarpolo">
        <fieldset>
            <legend>Dados</legend>
            <p class="centered centeredText boldedText">Campos com <img src="publico/imagens/icones/campo_obrigatorio.png"> são obrigatórios</label>
                ...
                <span class="line">
                    <label>Polo</label>
                    <input required type="text" class="input-xlarge" id="nomepolo" name="polo" value="<?php echo $this->polo ?>" />
                </span>
                <span class="line">
                    <label>Estado</label>
