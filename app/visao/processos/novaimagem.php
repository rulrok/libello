...
<form class="tabela centralizado" id="upload-image-form-ajax" method="POST" action="index.php?c=processos&a=verificarnovaimagem" enctype='multipart/form-data'>
    <fieldset>
        ...
        <div class="line">
            ...
            <div class="btn-toolbar" style="position:relative;left:15px;margin-bottom: 5px;">
                ...
                <img src="publico/processos/icones/campo_obrigatorio.png" style="display: initial;">
                <div class="hidden">
    ...
    <fieldset>
        ...
        <div class="centralizado">
            ...
            <br/>
            <img id="image-loading" alt="Carregando..." src="publico/processos/loader.gif" style="display: none;">
            <br/>
            <div id="image-info">
                <button id="remove-image-upload" style="display: none; margin-bottom: 10px; ">
                    <img src="publico/processos/cross.png" /> Remover
                </button>
                <br/>
                <div id="resultado_imagem">
                    <ul class="thumbnails">
                        <li class="span4">
                            <div class="thumbnail">
                                <img class="img-polaroid" alt="picture" src="publico/processos/350x150.jpg" id="image_preview">
                                <div class="caption">
                                    <h3>Visualização</h3>
                                    <div id="thumb_info">
...
//                    ajax("index.php?c=processos&a=criarthumb&imageURI=" + file.result, "#image_preview", false, true, true);
                    $.ajax({
                        url: "index.php?c=processos&a=criarthumb"
                        , type: "POST"
                        , async: true
...
//                console.log(this.name);
                if (this.selectedIndex !== 0) {
                    var $url = "index.php?c=processos&a=obterDescritor&n=" + desnum + "&p=" + this.value;
//                    console.log($url);
...
//                                liberarCadastro();
                    ...
                    $(wrap_id).load("index.php?c=processos&a=obterDescritor");
                }
            }
        });
    }
    ...
    $(document).ready(function() {
        ...
        if (window.File && window.FileReader && window.FileList && window.Blob) {
            ...
            $('#remove-image-upload').on('click', function(e)
            {
                ...
                $("#image_preview").prop('src', 'publico/processos/350x150.jpg');
...
//                liberarCadastro();
//            }, "200");
            ajax("index.php?c=processos&a=novaImagem", ".contentWrap", true, false, true); //TODO tirar essa gambiarra =s
        });
