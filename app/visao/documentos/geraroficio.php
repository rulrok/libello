...
//                    $('#form1').attr({action:'../../../includes/relatoriosPDF/teste.php'});
                    $('#form1').attr({action:'../../../includes/relatoriosPDF/gerarOficio.php?booledit=0'});
                }else{
                    if(acao == 'salvar'){
                        $('#msgSalvar').removeAttr('hidden');
                        $('#msgCadastro').attr({hidden: 'true'});
                        $('#form1').removeAttr("target");
                        $('#form1').attr({action:'../paginasAuxiliares/acoes.php?acao=salvarOficio&booledit=0'});
                    }
                }
            }
            ...
            function capturaNumOficio(){
                $.getJSON('../paginasAuxiliares/valores.ajax.php?search=',{valor: 1, ajax: 'true'}, function(j){
                    $('#i_numOficio').val(j);
     ...
     <table align="center">
                            ...
                            <table style='width: 794px; height: 1123px; font-family:"Times New Roman",Georgia,Serif; font-size: 15px; background-color: #FFF;' border="0" align="center">
                                ...
                                <tr height="30">
                                    <td align="left">
                                        <div align="center">
                                            <textarea style="max-height: 500px;min-height: 200px;max-width: 625px;min-width: 625px" id="corpo" name="corpo" onkeyup="liberarCadastro()">Corpo do Ofício</textarea>
                                        </div>
                                    </td>
                                </tr>
                                <tr height="40"><td></td></tr>
                                ...
                                <tr id="tr_confirmacao" height="50">
                                    ...
                                    <th>
                                        <div id="msgSalvar" hidden="true">
                                            ...
                                            <label>
                                                <input type="submit"  name="b_sim_s" id="b_sim_s" value="Sim" onclick="alert('Ofício salvo com sucesso.');"/>
                                            </label>
                                            <label>
