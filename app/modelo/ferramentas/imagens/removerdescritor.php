...
class removerdescritor extends Modelo\PaginaDeAcao {
    ...
    protected function _acaoPadrao() {
        ...
        try {
            ...
            if ($descritorExcluido['pai'] != null) {
                ...
                //TODO registrar essa ação
                $this->adicionarMensagemErro("Tentativa de excluir descritor raiz");
//                $this->abortarExecucao();
            ...
            if ($imagensDAO->executarQuery($sqlRemover, $paramsRemover)) {
                ...
                $this->adicionarMensagemSucesso("Descritor removido com sucesso");
                $imagensDAO->encerrarTransacao();
            } else {
                $this->adicionarMensagemErro("Falha ao remover descritor.");
